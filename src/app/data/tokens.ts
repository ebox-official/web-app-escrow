import { Token } from "../components/modals/token-selector/token";

let ETHEREUM_MAINNET: Token[] = [
  {
      "name": "Ethereum",
      "symbol": "ETH",
